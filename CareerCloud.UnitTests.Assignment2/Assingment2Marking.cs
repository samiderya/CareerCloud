...
namespace CareerCloud.UnitTests.Assignment2
{
    ...
    public class Assingment2Marking
    {
        ...
        private void SecurityLoginRoleCheck()
        {
            ...
            if (_securityLoginRole.Role != securityLoginsRolePoco.Role)
                Assert.Fail($"_securityLoginRole.Role:{_securityLoginRole.Role}--securityLoginsRolePoco.Role{securityLoginsRolePoco.Role}");
